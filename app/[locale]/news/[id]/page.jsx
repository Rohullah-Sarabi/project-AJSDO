...
function NewsDetails() {
    return (
        <div className="w-full p-3 sm:w-3/5 flex flex-col  border gap-5 justify-center items-center mx-auto my-5 text-[#3c3744]">
            <div className="flex flex-col gap-2 justify-start w-full border">
                <p className="text-sm sm:text-lg font-medium sm:font-semibold">Women Civil Society Organization (WCSO) Program </p>
                <p className="text-sm sm:text-lg font-medium sm:font-semibold text-[#b4c5e4]">{new Date().toLocaleDateString()}</p>
            </div>
            <Image src={"/assets/3.jpg"} width={500} height={500} className="w-full sm:h-96" />
            <p className="text-sm sm:text-lg  text-justify p-2 text-[#3c3744]">
