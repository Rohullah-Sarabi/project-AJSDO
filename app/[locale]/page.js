    ...
    <div className="w-full">
      ...
      <div className="flex flex-col flex-1 gap-5 w-11/12 sm:w-3/4 mx-auto">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col justify-center items-center sm:flex-row mb-5 gap-5 sm:gap-10">
            <div className="flex flex-col gap-1 w-full sm:w-1/2">
              <Link href={"/"}>
                <Image src={"/assets/Bamyan_WCSO_Sept_2023_2.jpg"} width={500} height={500} className="w-full" />
                <p className="text-[#3c3744] text-start font-semibold capitalize py-2 hover:text-[#3066be]">The Women Civil Society Organization (WCSO) program, implements by UN-Women in Afghanistan, is a vital initiative that focuses on supporting women-led organizations in the country</p>
              </Link>
            ...
            <div className="flex flex-col gap-1 w-full sm:w-1/2">
              <Link href={"/"}>
                <Image src={"/assets/Bamyan_WCSO_Sept_2023_2.jpg"} width={500} height={500} className="w-full" />
                <p className="text-[#3c3744] text-start font-semibold capitalize py-2">The Women Civil Society Organization (WCSO) program, implements by UN-Women in Afghanistan, is a vital initiative that focuses on supporting women-led organizations in the country</p>
              </Link>
              <p>{new Date().getDate()}</p>
            </div>
